...
dataset = dict(
    train=dict(
        type="DOTADataset",
        dataset_dir='workspace/JAD/datasets/processed_DOTA/trainval_1024_500_0.5-1.0-1.5',
        transforms=[
            dict(
                type="RotatedResize",
                min_size=1024,
    ...
    test=dict(
        type="ImageDataset",
        images_dir='workspace/JAD/datasets/processed_DOTA/test_1024_500_0.5-1.0-1.5/images/',
        transforms=[
            dict(
                type="RotatedResize",
                min_size=1024,
